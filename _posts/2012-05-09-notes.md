...
- Particle MCMC (Andrieu et al, J Roy Statistic Soc B, 2010)

Non-Bayesian 
------------

- Simulation-based prediction rules (Kendall et al. Ecology, 1999) "Probe-matching"
- Simulated likelihood of summary statistics (Wood Nature 2010)
- Iterated filtering (Ionides et al, PNAS 2006)
...
- Ionides, Breto & King PNAS 2006 (pseudo-code)
- Ionides et al, Annals of Statistics 2011 (proofs)
