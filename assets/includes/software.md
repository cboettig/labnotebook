...
- [`roxigraph`](https://github.com/cboettig/roxigraph): RDF and SPARQL for R using Oxigraph. Carl Boettiger (2026).
- [`rcloner`](https://github.com/cboettig/rcloner): Interface to the rclone Cloud Storage Utility. Carl Boettiger (2026).
...
- [`gym_climate`](https://github.com/boettiger-lab/gym-climate): A Simulation Environment for Deep Reinforcement Learning for climate policy scenarios. Carl Boettiger and Marcus Lapeyrolerie (2021).
