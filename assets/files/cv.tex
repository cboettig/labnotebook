...
\title{\textbf{University of California, Berkeley}}\location{Berkeley, CA 94720}\dates{07/01/2015 - present}
\begin{position}
NSF Postdoctoral Researcher \\
Mentors: Marc Mangel \& Stephan Munch 
\end{position}

\title{\textbf{University of California, Santa Cruz}}\location{Santa Cruz, CA 95064}\dates{10/15/2012 - 06/30/2015}
\begin{position}
NSF Postdoctoral Researcher \\
Mentors: Marc Mangel \& Stephan Munch 
\end{position}
...
\title{PI on \textbf{NSF} EAGER}\dates{2013-15}
\begin{position}
  The Codemeta Project: A Rosetta Stone for Software Metadata (\$165,782)
  \vspace{-.25cm}
\end{position}

\title{Co-PI on \textbf{Helmsley Trust} Grant}\dates{2015-18}
\begin{position}
...
\title{Co-PI on \textbf{Alfred P. Sloan Foundation} Grant, Phase II}\dates{2014-15}
\begin{position}
...
\title{Co-PI on \textbf{Alfred P. Sloan Foundation} Grant}\dates{2013-14}
\begin{position}
