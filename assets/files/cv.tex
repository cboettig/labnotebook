...
\title{MBI \textbf{invited speaker}}\dates{2013}
\begin{position}
...
\title{\emph{\textbf{NSF} Mathematical Biology Postdoctoral Scholar}, DBI-1306697}\dates{2013-15}
\begin{position}
...
\title{\emph{PI on DOE Grant No. DE-AC02-05CH11231}}\dates{2011, renewed 2012}
\begin{position} 
50,000 hr supercomputing on NERSC machines
  \vspace{-.25cm}
\end{position}

\title{\emph{\textbf{NAS} IIASA YSSP fellowship}}\dates{2009}
\begin{position} 
  National Academy of Sciences, NSF Grant No. OISE-0738129, (\$8,000)
  \vspace{-.25cm}
\end{position}

\title{\emph{\textbf{DOE} Computational Science Graduate Fellowship}}\dates{2008-2012}
\begin{position} 
