...
A condensed, two-page version is generated from the *same* sources (no separate
copy to keep in sync):

```sh
bash static/files/update_2pg_cv.sh
cp static/files/2pg-cv.pdf docs/files/2pg-cv.pdf
```

`static/files/make_2pg_vita.py` pulls employment, education, grants, awards,
